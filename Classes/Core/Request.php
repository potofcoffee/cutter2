...
class Request
{
     ...
     * @param \string $argument Argument name
     * @param \bool $urlDecode True if urldecode() should be applied (default: true)
     * @return  variant Argument value or FALSE if argument not present
     */
    public function getArgument($argument, $urlDecode = true)
    {
        return ($this->hasArgument($argument) ? ($urlDecode ? urldecode($this->data[$argument]) : $this->data[$argument]) : false);
    }
